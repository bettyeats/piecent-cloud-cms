...
function left_admin_footer_text($text) {
	$text = '<span id="footer-thankyou">感谢使用<a href="http://cms.piecent.com/">Piecent Cloud CMS</a>进行创作</span>'; 
	return $text;
}
...
function custom_right_now_text($content) {
	$text = "Picent Cloud CMS";
	return $text;
}
...
function custom_login_logo() { ?>
    <style type="text/css">
        #login h1 a, .login h1 a {
            background-image: url(http://cn.bing.com/sa/simg/CN_Logo_Gray.png) !important;
            padding-bottom: 30px;
        }
    </style>
<?php }
